                            ...
                            @forelse ($vacante->candidatos as $candidato)
                                <li class="p-3 flex items-center">
                                    <div class="flex-1">
                                       ...
                                       <p class="text-md text-gray-600">{{$candidato->user->email}}</p>
                                       <p class="text-md font-medium text-gray-600">Dia que se postulo: <span class=" font-normal">{{$candidato->created_at->diffForHumans()}}</span></p>
                                    </div>

                                    <div>
                                        {{-- Mostrar el curriculum del que se esta postulando --}}
                                        <a 
