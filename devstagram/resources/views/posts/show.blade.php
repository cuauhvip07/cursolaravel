        ...
        <div class=" md:w-1/2">
            ...
            <div class="p-3 flex items-center gap-x-4">
                ...
                {{-- Manda a llamar la funcion del Modelo Post y verifica que este autenticado --}}
                    ...
                    @else
                        <form action="{{route('posts.likes.store',$post)}}" class=" m-0" method="POST">
                            @csrf
                            <div class="my-4">
                                <button type="submit">
                ...
                @endauth
{{-- likes viene del Modelo Post y se trae la funcion de likes  --}}
 ...
 {{-- Carbon -> libreria integrada que ayuda a ponernos las fechas para humanos --}}
            ...
            {{-- Eliminar un post y valida si es el usuario el que la quiere eliminar --}}
            @auth
